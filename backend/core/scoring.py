...
class LivabilityScorer:
    ...
    IMPORTANCE_MULTIPLIERS = {"excluded": 0.0, "low": 0.5, "medium": 1.0, "high": 1.5}
    ...
    @classmethod
    def get_multiplier(
        cls, preferences: Optional[Dict[str, str]], factor_key: str
    ) -> float:
    ...
    def calculate_score(
        ...
        bike_infra_base = cls.calculate_bike_infrastructure_score(
            bike_infrastructure_count
        )
        ...
        bike_infra = bike_infra_base * cls.get_multiplier(
            preferences, "bike_infrastructure"
        )
        ...
        pedestrian = pedestrian_base * cls.get_multiplier(
            preferences, "pedestrian_infrastructure"
        )
        ...
        industrial_penalty = industrial_base * cls.get_multiplier(
            preferences, "industrial"
        )
        ...
        gas_station_penalty = gas_station_base * cls.get_multiplier(
            preferences, "gas_station"
        )
        ...
        construction_penalty = construction_base * cls.get_multiplier(
