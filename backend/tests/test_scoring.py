...
class TestScoringConstants:
    ...
    def test_base_score_value(self):
        ...
        assert LivabilityScorer.BASE_SCORE == 50.0
...
class TestGreeneryScore:
    ...
    def test_many_parks_caps_at_max(self):
        ...
        assert score == 6.0  # Max park score (min of 6.0)
