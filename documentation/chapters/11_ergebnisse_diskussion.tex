...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\linewidth]{map_geojson}
    \caption{Kartenansicht mit GeoJSON-Markern}
    \label{fig:map_geojson}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\linewidth]{score_detail}
    \caption{Score-Aufschlüsselung nach Faktoren}
    \label{fig:score_detail}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\linewidth]{preferences}
    \caption{Individuelle Präferenzeinstellung}
    \label{fig:preferences}
  \end{subfigure}
  \caption{Mobile Ansichten der Anwendung (iOS)}
  \label{fig:app_screenshots}
\end{figure}

Abbildung~\ref{fig:web_score_view} zeigt die Webanwendung im
Desktop-Browser mit Kartenansicht, farbcodierten GeoJSON-Markern und
der Score-Aufschlüsselung nach positiven und negativen Faktoren.

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{web_score_view}
  \caption{Webanwendung im Desktop-Browser: Kartenansicht mit Score-Aufschlüsselung}
  \label{fig:web_score_view}
\end{figure}
