...
PostgreSQL~16 mit der Erweiterung PostGIS~3.4 \parencite{postgis_docs,
      postgresql_docs}. Dieses Kapitel beschreibt das Datenbankschema, die
...
Das Schema umfasst \textbf{21 Tabellen}, die sich in drei Gruppen
unterteilen lassen:
...
\begin{enumerate}
      ...
      \item \textbf{Benutzerverwaltung} (2 Tabellen): \texttt{users},
            \texttt{favorite\_addresses}
\end{enumerate}
...
Die Benutzertabellen speichern Firebase-UIDs, E-Mail-Adressen und
Favoriten-Koordinaten.
...
\parencite{geoalchemy2_docs}. Alle 21 Tabellen erben von einer gemeinsamen
Basisklasse \texttt{GISBase} mit der Konfiguration
\texttt{arbitrary\_types\_allowed = True}.
